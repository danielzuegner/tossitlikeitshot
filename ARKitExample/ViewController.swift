...
class ViewController: UIViewController, ARSCNViewDelegate, UIPopoverPresentationControllerDelegate, VirtualObjectSelectionViewControllerDelegate {
    ...
    func setupScene() {
        ...
        omniLightNode.light!.type = SCNLight.LightType.spot
	...
	var isLoadingObject: Bool = false {
		didSet {
			DispatchQueue.main.async {
				...
				self.createBallButton.isEnabled = !self.isLoadingObject
    ...
    func addPlane(node: SCNNode, anchor: ARPlaneAnchor) {
        ...
        planeNode.worldPosition = SCNVector3Make(pos.x, pos.y, pos.z)
...
//        node.addChildNode(plane)
	...
	@IBOutlet weak var createBallButton: UIButton!
	
	@IBAction func createBall() {
